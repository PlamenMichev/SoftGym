...
namespace SoftGym.Data.Migrations
{
    ...
    [Migration("20200416134534_AddFieldToAppointments")]
    partial class AddFieldToAppointments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftGym.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SoftGym.Data.Models.Message", b =>
                {
                    b.HasOne("SoftGym.Data.Models.ApplicationUser", "Reciever")
                        .WithMany("RecievedMessages")
                        .HasForeignKey("RecieverId");

                    b.HasOne("SoftGym.Data.Models.ApplicationUser", "Sender")
